...
<section>
  ...
  <form method="post" action="search.jsp">
  	<center>Enter Roll Number: <input type="search" name="searchStudent" placeholder="Search by Student Details">
...
<section>
  ...
  <form method="post" action="search.jsp">
  	<center>Enter Roll Number: <input type="search" name="searchResult" placeholder="Search results">
  	<input type="submit" value="search">
  	</center>
  </form>
  	</div>
